...
public class OrderDetail extends IdBaseEntity {
	...
	public OrderDetail(String categoryName, int quantity, float productCost, float shippingCost, float unitPrice,
			float subtotal) {
	...
	public OrderDetail(String productName, int quantity, float productCost, float shippingCost, float subtotal) {
