...
public class PagingAndSortingArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer model, NativeWebRequest request,
		...
		PagingAndSortingParam anotation = parameter.getParameterAnnotation(PagingAndSortingParam.class);
		...
		model.addAttribute("moduleURL", anotation.moduleURL());

		return new PagingAndSortingHelper(model, anotation.listName(), sortField, sortDir,
				keyword);
	}
